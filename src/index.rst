...
.. raw:: html
   ...
   <div class="warning">
      ...
      <br/>
      For a detailed list of the supported OS versions, see the <a href="https://toltec-dev.org/stable/Compatibility">compatibility table</a>.
      <br/>
      For running third party software on the latest OS versions, we recommend using <a href="https://github.com/vellum-dev/vellum">vellum</a> and <a href="https://remanager.io/">reManager</a>.
   </div>
