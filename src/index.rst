...
**Warning:** *Toltec does not yet support any OS build newer than OS 2.10.3.379. You will likely soft-brick your device if you install before support is released. See* `remarkable2-recovery <https://github.com/ddvk/remarkable2-recovery>`_ *for information on how to recover your device if you have done this.*
